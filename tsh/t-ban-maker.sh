...
#
# Termux Banner Maker
# Banner by Saiful Islam Imon(MR.SUN)
#💓 _____Do Not Copy Or Modify_____💓
#
#
clear
figlet -f big Termux Banner Maker| lolcat
cyan='\e[0;36m'
lightgreen='\e[1;32m'
red='\e[1;31m'
yellow='\e[1;33m'
echo -e $lightgreen "\e[1m                Security Help For Ethical Hackers BD"
echo " "
echo -e $yellow "\e[1m                         -Saiful Islam Imon(MR.SUN)"
echo " "
echo " "
echo " "
